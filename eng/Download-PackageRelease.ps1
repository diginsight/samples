...
$VersionProjectPath = Join-Path $RepositoryRoot 'src' '01. Authentication' 'AuthenticationSampleApi' 'AuthenticationSampleApi.csproj'
...
Write-Host ''
Write-Host 'Run: dotnet restore src/Diginsight.Samples.slnx --force-evaluate'
