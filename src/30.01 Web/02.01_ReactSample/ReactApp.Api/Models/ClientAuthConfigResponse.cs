namespace ReactApp.Api.Models
{
    /// <summary>
    /// Authentication configuration served by the API (<c>ReactApp.Api</c>) to the
    /// React single-page application (<c>ReactApp.Client</c>).
    /// This allows the SPA to obtain its app registration (client id / authority)
