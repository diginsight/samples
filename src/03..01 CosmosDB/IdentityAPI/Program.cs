...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        using (var activity = Observability.ActivitySource.StartMethodActivity(logger, new { args }))
        {
            ...
            builder.Services.AddObservability(observabilityManager, configuration, environment); logger.LogDebug("builder.Services.AddObservability(observabilityManager, configuration, environment);");

            builder.Services.Configure<CosmosDbOptions>("IdentityCosmosDbOptions", configuration.GetSection("Identity:CosmosDbOptions"));
